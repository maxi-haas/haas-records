	...
	<div class="row press"> <!-- row About -->
		...
		<div class="row">
			<div class="col-md-12 col-lg-12">
				<form class="contact_form" id="form1" name="form1" method="post" action="datos.php">
		...
		<div class="row">
			...
			<div class="col-md-6 col-lg-6">
					...
					<textarea name="mensaje" type="textarea" class="form-control" rows="5" id="mensaje" placeholder="Required" required></textarea>
					</div>
